...
public class VolumeOverTime {
	...
	public VolumeOverTime(String companyName, String companySymbol, String startDate, String endDate, int[] days, int[] months, int[] years,
			String[] volumes) {
