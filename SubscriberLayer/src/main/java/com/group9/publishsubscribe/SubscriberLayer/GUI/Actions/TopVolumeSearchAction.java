...
public class TopVolumeSearchAction implements ActionListener {
	
	private final App backend;
	private final TopVolumeSearchActionContext context;
	
	public TopVolumeSearchAction(App backend, TopVolumeSearchActionContext context) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		backend.topVolumeRequest(year + month + day);
